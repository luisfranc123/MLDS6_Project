...
filled_df = regressor_imputer(df, feature, max_depth = 6)
numeric_df = replace_missing(df, mising_list)
X_train, X_test, y_train, y_test = split_data(X. y, test_size = 0.2, random_state = 46) 
